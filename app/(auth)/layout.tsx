    ...
    <>
      ...
      <main className="relative flex grow">
        <div
          ...
          aria-hidden="true"
        >
          <div className="h-80 w-80 rounded-full bg-gradient-to-tr from-orange-200 opacity-70 blur-[160px]"></div>
        </div>
              ...
              <div className="aspect-video w-full rounded-2xl bg-gray-900 px-5 py-3 shadow-xl transition duration-300">
                ...
                <div className="font-mono text-sm text-gray-500 transition duration-300 [&_span]:opacity-0">
                  ...
                  <span className="animate-[code-2_10s_infinite]">
                    initializing FlowSense data analysis...
                  </span>
                  <br />
                  <span className="animate-[code-3_10s_infinite]">
                    scanning high-risk areas
                  </span>{" "}
                  ...
                  <span className="animate-[code-5_10s_infinite] text-gray-200">
                    updating real-time recommendations
                  </span>
                  <br />
                  <span className="animate-[code-6_10s_infinite]">
                    FlowSense operational.
                  </span>
                </div>
              </div>
            </div>
