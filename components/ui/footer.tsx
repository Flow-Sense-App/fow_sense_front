  ...
  return (
    <footer>
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        >
          {/* 1st block */}
          <div className="space-y-2 justify-center items-center text-center sm:col-span-12 lg:col-span-4">
            <div>
              <Logo />
            </div>
            <div className="text-sm text-gray-600">
              &copy; FlowSense.com - All rights reserved.
            </div>
          </div>

          {/* 2nd block */}
          <div className="space-y-2 justify-center items-center text-center sm:col-span-6 md:col-span-3 lg:col-span-4">
          ...
          <div className="space-y-2 justify-center items-center text-center sm:col-span-6 md:col-span-3 lg:col-span-4">
            ...
            <ul className="flex-row items-center justify-center gap-1 text-sm">
              <li>
                <Link
                  className="flex items-center justify-center text-orange-500 transition hover:text-orange-600"
                  href="https://github.com/SebasDosman"
                  target="_blank"
              ...
              <li>
                <Link
                  className="flex items-center justify-center text-orange-500 transition hover:text-orange-600"
                  href="https://github.com/AgustdSrOscuro7"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Github"
                >
